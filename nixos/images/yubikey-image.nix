...
in
{
  ...
  # see https://discourse.nixos.org/t/impossible-to-log-in-to-result-of-nixos-rebuild-build-vm/9895/7 ico errors
  # with graphical ui (vm): "yubikey" & "Switch user / Unlock" [without putting anything in password box] and with console (vm-nogui) login:yubikey
  # change password imperatively when needed
